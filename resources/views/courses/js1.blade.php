...
$str
            ...
            <section id="ch3">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            chapter 3: Types, Values, and Variables (p29)
                        </h3>
                    </div>
                    <div class="panel-body">
                    </div>
    ...
    <ul class="nav nav-stacked" data-offset-top="80" data-spy="affix">
        <li>
            ...
            <ul class="nav nav-stacked">
                <li><a href="#ch2-section1">2.1 Character Set</a></li>
                <li><a href="#ch2-section2">2.2 Comments</a></li>
                <li><a href="#ch2-section3">2.3 Literals</a></li>
            </ul>
        </li>
        <li>
            <a href="#ch3">chapter 3: Types, Values, and Variables</a>
            <ul class="nav nav-stacked">
                <li><a href="#ch3-section1">3.1 Numbers (31)</a></li>
                <li><a href="#ch3-section2">3.2 Text (36)</a></li>
                <li><a href="#ch3-section3">3.3 Boolean Values (40)</a></li>
                <li><a href="#ch3-section4">3.4 null and undefined (41)</a></li>
                <li><a href="#ch3-section5">3.5 The Global Object (42)</a></li>
                <li><a href="#ch3-section6">3.6 Wrapper Objects(43)</a></li>
                <li><a href="#ch3-section7">3.7 Immutable Primitive Values and Mutable Object References 44(44)</a></li>
                <li><a href="#ch3-section8">3.8 Type Conversions (45)</a></li>
                <li><a href="#ch3-section9">3.9 Variable Declaration (52)</a></li>
                <li><a href="#ch3-section10">3.10 Variable Scope (53)</a></li>
            </ul>
        </li>
